...
const Header = () => {
    return (
        <header className="flex flex-col items-center gap-12 w-full">
            <div className="flex w-full items-center justify-center bg-orange-400
            ...
            <div className="w-full mx-auto
                ...
                <div className="flex items-center gap-[50px] w-[390px] xl:w-[502px] 2xl:w-[597px]">
                    <img src="/img/Logo.png" alt="logo" className="h-[45px] 2xl:h-[55px]"/>
                    <div className="hidden sm:block">
                        <Navbar/>
                    </div>
                </div>
                <div className="flex gap-5 xl:gap-[30px] w-[151px] h-[45px] xl:w-[169px] xl:h-[45px]
