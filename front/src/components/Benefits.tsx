...
const cardItems = [
  ...
  },
  {
    ...
    subtitle:
      "Collaborate with fellow learners, exchanging ideas and feedback to enhance understanding.",
    img: "arrow",
  },
];
...
function Benefits() {
  return (
    ...
    >
      ...
      />
      <div
        className="flex flex-col md:flex-row gap-5 w-full h-full px-2 xl:px-4 2xl:px-6 py-2 xl:py-4
                            2xl:py-6"
      >
        <div className="flex flex-wrap gap-5">
          {cardItems.map((item, index) => (
            ...
            >
              <div
                className="flex flex-col justify-between gap-[30px] w-full h-full px-2
                                xl:px-4 2xl:px-6 py-2 xl:py-4 2xl:py-6 xl:gap-10 2xl:gap-[50px]"
              >
                <div
                  className="flex self-end font-bold text-[50px] h-[37px] xl:text-[60px]
                                    xl:h-[44px] 2xl:text-[60px] 2xl:h-[56px]"
                >
                  {item.number}
                </div>
                <div
                  className="flex flex-col items-start xl:gap-[10px] 2xl:gap-[14px]
                                    px-2 xl:px-4 2xl:px-6 py-2 xl:py-4 2xl:py-6"
                >
                  <div className="flex font-semibold text-xl 2xl:text-2xl">
                    {item.title}
                  </div>
                  <div className="flex font-normal text-sm xl:text-base 2xl:text-lg">
                    {item.subtitle}
                  </div>
                </div>
                <button
                  className="flex items-center justify-center self-end bg-[#FCFCFD]
