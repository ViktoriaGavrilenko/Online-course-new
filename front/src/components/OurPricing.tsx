...
function OurPricing() {
  return (
    <div
      className="flex flex-col gap-10 w-full xl:gap-[60px] xl:max-w-[1279px]
    ...
    >
      ...
      />
      <div
        className="flex flex-col sm:flex-row justify-center items-center flex-wrap w-full h-full
                            px-12 py-12 bg-white gap-[30px] 2xl:gap-[30px]"
      >
        {pricingItems.map(({ plan, price, features }) => (
          <div
            key={plan}
            className="flex flex-col items-center justify-center bg-[#FCFCFD]
                                 rounded-xl w-full h-full px-12 py-12 flex-[1_1_calc(50%-20px)] max-w-[100%]
                                 gap-[30px] xl:gap-[50px] 2xl:gap-[50px]"
          >
            <div
              className="flex items-center justify-center font-medium color-[#262626]
                            bg-[#FFEACC] rounded-sm w-full px-2 py-2 2xl:text-[22px] 2xl:rounded-md"
            >
              {plan}
            </div>
            <div className="flex justify-center items-center w-full">
              <div
                className="flex color-[#262626] font-semibold text-[50px] xl:text-[60px]
                                                2xl:text-[80px]"
              >
                {price}
              </div>
              <div
                className="flex color-[#4C4C4D] font-semibold text-sm
                                                xl:text-base 2xl:text-xl "
              >
                /month
              </div>
            </div>
            <div
              className="flex flex-col justify-end items-center bg-white w-full h-full
            ...
            >
              ...
              >
                <div
                  className="flex justify-center font-semibold text-lg color-[#262626]
                                                    w-full 2xl:text-xl"
                >
                  Available Features
                </div>
                ...
                >
                  {features.map(({ img, text }) => (
                    ...
                    >
                      ...
                      />
                      <div
                        className="flex color-[#4C4C4D] font-normal
                                                         text-sm tracking-tighter 2xl:text-lg"
                      >
                        {text}
                      </div>
                    </div>
              ...
              <button
                className="flex justify-center items-center font-semibold text-sm
                                color-white bg-[#FF9500] w-full py-2 2xl:text-lg"
              >
                Get Started
              </button>
            </div>
