...
interface Props {}
const front_end_webItems = [
    {title:"HTML Fundamentals", lesson:"Lesson 01",img:"watch", time:"45 Minutes"},
    {title:"CSS Styling and Layouts", lesson:"Lesson 02",img:"watch", time:"1 Hour"},
    {title:"JavaScript Basics", lesson:"Lesson 03",img:"watch", time:"45 Minutes"},
]

const Front_End_WebPage: React.FC<Props> = () => {
  return (
    <div className="flex flex-col gap-20 bg-grey-50">
      <div className="flex justify-around gap-60">
        ...
        >
        Become proficient in front-end web development. Learn HTML, CSS, JavaScript, and popular 
        frameworks like Bootstrap and React. Build interactive and responsive websites. </div>
      </div>
      ...
      <div className='flex flex-col items-center gap-[50px] px-8 2xl:w-[783px] 2xl:h-[698px] outline-1 outline-red-400'>
        ...
        <div className='flex flex-col gap-5 2xl:w-[683px] 2xl:h-[403px] tracking-wide outline-1 outline-blue-900'>
           {front_end_webItems.map(({title, lesson, img, time}, index) => (
...
export default Front_End_WebPage;