...
const mobileAppItems = [
    {title:"Introduction to Mobile App Development", lesson:"Lesson 01",img:"watch", time:"45 Minutes"},
    {title:"Fundamentals of Swift Programming (iOS)", lesson:"Lesson 02",img:"watch", time:"1 Hour"},
    {title:"Fundamentals of Kotlin Programming (Android)", lesson:"Lesson 03",img:"watch", time:"45 Minutes"},
]

const MobileAppPage: React.FC<Props> = () => {
  return (
     <div className="flex flex-col gap-20 bg-grey-50">
      <div className="flex justify-around gap-60">
        ...
        >
         ...
         applications using industry-leading frameworks like Swift and Kotlin. </div>
      </div>
      ...
      <div className='flex flex-col items-center gap-[50px] px-8 2xl:w-[783px] 2xl:h-[698px] outline-1 outline-red-400'>
        ...
        <div className='flex flex-col gap-5 2xl:w-[683px] 2xl:h-[403px] tracking-wide outline-1 outline-blue-900'>
           {mobileAppItems.map(({title, lesson, img, time}, index) => (
