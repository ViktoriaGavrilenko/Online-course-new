...
const graphicDesignItems = [
    {title:"Introduction to Graphic Design", lesson:"Lesson 01",img:"watch", time:"45 Minutes"},
    {title:"Typography and Color Theory", lesson:"Lesson 02",img:"watch", time:"1 Hour"},
    {title:"Layout Design and Composition", lesson:"Lesson 03",img:"watch", time:"45 Minutes"},
]

const GraphioDesignPage: React.FC<Props> = () => {
  return (
   <div className="flex flex-col gap-20 bg-grey-50">
      <div className="flex justify-around gap-60">
        ...
        >
         Discover the fundamentals of graphic design, including typography, color theory, layout 
         design, and image manipulation techniques. Create visually stunning designs for print 
         and digital media. </div>
      </div>
      ...
      <div className='flex flex-col items-center gap-[50px] px-8 2xl:w-[783px] 2xl:h-[698px] outline-1 outline-red-400'>
        ...
        <div className='flex flex-col gap-5 2xl:w-[683px] 2xl:h-[403px] tracking-wide outline-1 outline-blue-900'>
           {graphicDesignItems.map(({title, lesson, img, time}, index) => (
...
export default GraphioDesignPage;